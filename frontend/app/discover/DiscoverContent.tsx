...
function CareerCard({ career, onViewRoadmap }: { career: Career; onViewRoadmap: (c: Career) => void }) {
  return (
    <div
      className="glass glass-hover rounded-2xl p-6 flex flex-col justify-between border border-white/[0.07] cursor-pointer group hover:border-violet-500/30 transition-all duration-200"
    ...
    >
      <div>
        <div className="flex items-start justify-between gap-3 mb-2">
          ...
          <div className="flex items-center gap-1 text-emerald-400 text-xs sm:text-sm font-semibold whitespace-nowrap bg-emerald-500/10 px-2 py-0.5 rounded-lg border border-emerald-500/20">
...
export default function DiscoverContent() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
      ...
      <div className="flex gap-3 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full bg-white/[0.04] border border-white/10 rounded-xl pl-11 pr-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-violet-500/50 focus:bg-white/[0.06] transition-all"
          />
        </div>
        <button
          id="toggle-filters"
      ...
      {showFilters && (
        <div className="glass rounded-2xl p-5 mb-6 flex flex-wrap gap-6 border border-white/10">
          <div>
            <p className="text-xs text-gray-400 uppercase tracking-wider mb-2 font-semibold">Difficulty</p>
